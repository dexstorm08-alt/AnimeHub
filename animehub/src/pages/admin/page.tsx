...
import { useAdminStats, useRecentActivity, useSystemHealth } from '../../hooks/useAdmin';
import { useAuthContext } from '../../contexts/AuthContext';
import { usePerformanceMetrics } from '../../components/PerformanceMonitor';
import { useServiceWorker } from '../../utils/serviceWorker';

export default function AdminDashboard() {
  const navigate = useNavigate();
  const { refreshSession, isSessionValid } = useAuthContext();
